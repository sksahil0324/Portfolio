          ...
          {data.projects.map((project, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }} transition={{ duration: 0.5, delay: idx * 0.12 }}
                whileHover={{ y: -4 }}
                ...
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <div className="flex gap-2 shrink-0">
                    <a href={project.githubUrl || "#"} target="_blank" rel="noreferrer" aria-label="GitHub"
                      className="p-2 rounded-lg glass hover:text-primary transition-colors" data-testid={`project-github-${idx}`}>
                      <Github size={16} />
                    </a>
                    <a href={project.demoUrl || "#"} target="_blank" rel="noreferrer" aria-label="Demo"
                      className="p-2 rounded-lg glass hover:text-primary transition-colors" data-testid={`project-demo-${idx}`}>
