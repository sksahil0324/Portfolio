...
const colorMap: Record<string, string> = {
  ...
  "chart-4": "bg-purple-400 text-black",
  "chart-5": "bg-teal-400 text-black",
};
              ...
              >
                ...
                <div className="glass-card rounded-2xl p-8 hover:border-white/20 transition-all duration-300">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tech.map((t) => (
                      <span key={t} className="px-3 py-1 rounded-full text-xs font-medium glass border border-white/10 text-muted-foreground">
                        {t}
                      </span>
                    ))}
                  </div>
